            ...
            <div className="flex h-16 justify-start items-center">
              <div className="flex justify-center flex-row w-full">
                ...
                <div className="flex flex-shrink-0 items-center">
                  {/* Logo */}
                  <div className="flex flex-shrink-0 items-center">
                    {/* New Logo with increased size and rounded */}
                    <img
                      src={logo1}
                      alt="Logo"
                  ...
                  <div className="hidden md:ml-6 md:flex md:space-x-8">
                    <Link
                      to="/dashboard"
                      className="inline-flex items-center px-1 pt-1 text-lg font-bold text-gray-900 border-b-4 border-transparent hover:border-indigo-500 transition duration-300 ease-in-out"
                    >
                      <span className="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
                        MoneyTrail
                      </span>
                    </Link>
                  </div>
